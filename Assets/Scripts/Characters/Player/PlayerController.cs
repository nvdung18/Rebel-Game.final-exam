...
public class PlayerController : MonoBehaviour
{
    ...
    {
        if (col.gameObject.CompareTag("Walkable") || col.gameObject.CompareTag("Enemy") || col.gameObject.CompareTag("Marco Boat") || col.gameObject.CompareTag("Terrain") || col.gameObject.CompareTag("Building"))
        {
            isGrounded = true;

...
public class CameraManager : MonoBehaviour
{
    ...
    public CinemachineVirtualCamera vcamZ3C;
    ...
    void Awake()
    {
        if (current)
            Destroy(current);
        current = this;
        /*SwitchCameras(vcamZ2B, vcamZ3A);*/
    }

    #region Rebel Editor Switches 
    public void SwitchZ1AtoZ2A()
    {
        SwitchCameras(vcamZ1A, vcamZ2A);
    }
    public void SwitchZ2BtoZ3A()
    {
        Debug.Log(1234);
        SwitchCameras(vcamZ2B, vcamZ3A);
    }
    ...
    public void SwitchZ3BtoZ3C()
    {
        SwitchCameras(vcamZ3B, vcamZ3C);
    }
    #endregion
    ...
    #region Mission 1 Rebel Switches
    public static void AfterDestroyHeli()
    {
        //If there is no current Camera Manager, exit
        if (current == null)
            return;

        current.SwitchZ1AtoZ2A();
    }
    public static void DoneSecondPart()
    {
        //If there is no current Camera Manager, exit
        if (current == null)
            return;

        current.SwitchZ2BtoZ3A();
    }
    public static void AfterSwitchZ2BToZ3A()
    {
        //If there is no current Camera Manager, exit
        if (current == null)
            return;

        current.SwitchZ3AtoZ3B();
    }
    public static void AfterSwitchZ3AToZ3B()
    {
        //If there is no current Camera Manager, exit
        if (current == null)
            return;

        current.SwitchZ3BtoZ3C();
    }
    #endregion
